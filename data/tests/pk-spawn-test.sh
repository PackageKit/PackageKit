...
sleep ${time}
echo -e "package\tavailable\tpackage\tpolkit;0.0.1;i386;data\tPolicyKit daemon"
echo -e "package\tinstalled\tpackage\tpolkit-gnome;0.0.1;i386;data\tPolicyKit helper for GNOME"
sleep ${time}
echo -e -n "package\tavailable\tpackage\tConsoleKit"
sleep ${time}
...
echo -e "package\tinstalled\tpackage\tgnome-power-manager;0.0.1;i386;data\tMore useless software"
sleep ${time}
