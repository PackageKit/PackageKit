...
test_filter_package_installed ()
{
	...
	g_assert_true (slack::filter_package (filters, true));
	g_assert_false (slack::filter_package (filters, false));
}
...
test_filter_package_not_installed ()
{
	...
	g_assert_true (slack::filter_package (filters, false));
	g_assert_false (slack::filter_package (filters, true));
}
