			      ...
			      const gchar *directory)
{
	...
	pkalpm_backend_run (job, PK_STATUS_ENUM_SETUP, pk_backend_download_packages_thread, NULL);
}
...
pk_backend_install_packages (PkBackend  *self,
			     ...
			     gchar **package_ids)
{
	pkalpm_backend_run (job, PK_STATUS_ENUM_SETUP, pk_backend_install_packages_thread, NULL);
}
...
pk_backend_update_packages (PkBackend *self,
			    ...
			    gchar **package_ids)
{
	pkalpm_backend_run (job, PK_STATUS_ENUM_SETUP, pk_backend_update_packages_thread, NULL);
}
