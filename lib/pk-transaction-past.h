...
#define PK_TRANSACTION_PAST(o) \
	(G_TYPE_CHECK_INSTANCE_CAST ((o), PK_TYPE_TRANSACTION_PAST, PkTransactionPast))
#define PK_TRANSACTION_PAST_CLASS(k) \
	(G_TYPE_CHECK_CLASS_CAST((k), PK_TYPE_TRANSACTION_PAST, PkTransactionPastClass))
...
#define PK_TRANSACTION_PAST_GET_CLASS(o) \
	(G_TYPE_INSTANCE_GET_CLASS ((o), PK_TYPE_TRANSACTION_PAST, PkTransactionPastClass))
