			      ...
			      GError **error)
{
	...
	/* run async method */
	pk_task_remove_packages_async (task,
				       package_ids,
				       allow_deps,
				       autoremove,
				       cancellable,
			      ...
			      GError **error)
{
	...
	/* run async method */
	pk_task_update_packages_async (task,
				       package_ids,
				       cancellable,
				       progress_callback,
				       progress_user_data,
			    ...
			    GError **error)
{
	...
	/* run async method */
	pk_task_install_files_async (task,
				     files,
				     cancellable,
				     progress_callback,
				     progress_user_data,
			    ...
			    GError **error)
{
	...
	/* run async method */
	pk_task_search_groups_async (task,
				     filters,
				     values,
				     cancellable,
				     progress_callback,
			  ...
			  GError **error)
{
	...
	/* run async method */
	pk_task_get_details_async (task,
				   package_ids,
				   cancellable,
				   progress_callback,
				   progress_user_data,
				...
				GError **error)
{
	...
	/* run async method */
	pk_task_get_update_detail_async (task,
					 package_ids,
					 cancellable,
					 progress_callback,
					 progress_user_data,
				...
				GError **error)
{
	...
	/* run async method */
	pk_task_download_packages_async (task,
					 package_ids,
					 directory,
					 cancellable,
					 progress_callback,
			  ...
			  GError **error)
{
	...
	/* run async method */
	pk_task_get_updates_async (task,
				   filters,
				   cancellable,
				   progress_callback,
				   progress_user_data,
			  ...
			  GError **error)
{
	...
	/* run async method */
	pk_task_required_by_async (task,
				   filters,
				   package_ids,
				   recursive,
				   cancellable,
			    ...
			    GError **error)
{
	...
	/* run async method */
	pk_task_what_provides_async (task,
				     filters,
				     values,
				     cancellable,
				     progress_callback,
			    ...
			    GError **error)
{
	...
	/* run async method */
	pk_task_refresh_cache_async (task,
				     force,
				     cancellable,
				     progress_callback,
				     progress_user_data,
			    ...
			    GError **error)
{
	...
	/* run async method */
	pk_task_get_repo_list_async (task,
				     filters,
				     cancellable,
				     progress_callback,
				     progress_user_data,
			  ...
			  GError **error)
{
	...
	/* run async method */
	pk_task_repo_enable_async (task,
				   repo_id,
				   enabled,
				   cancellable,
				   progress_callback,
			     ...
			     GError **error)
{
	...
	/* run async method */
	pk_task_upgrade_system_async (task,
				      distro_id,
				      upgrade_kind,
				      cancellable,
				      progress_callback,
			    ...
			    GError **error)
{
	...
	/* run async method */
	pk_task_repair_system_async (task,
				     cancellable,
				     progress_callback,
				     progress_user_data,
				     (GAsyncReadyCallback) pk_task_generic_finish_sync,
