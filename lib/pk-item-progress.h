...
#define PK_ITEM_PROGRESS(o) \
	(G_TYPE_CHECK_INSTANCE_CAST ((o), PK_TYPE_ITEM_PROGRESS, PkItemProgress))
#define PK_ITEM_PROGRESS_CLASS(k) \
	(G_TYPE_CHECK_CLASS_CAST((k), PK_TYPE_ITEM_PROGRESS, PkItemProgressClass))
...
#define PK_ITEM_PROGRESS_GET_CLASS(o) \
	(G_TYPE_INSTANCE_GET_CLASS ((o), PK_TYPE_ITEM_PROGRESS, PkItemProgressClass))
