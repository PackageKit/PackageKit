...
#define PK_DISTRO_UPGRADE(o) \
	(G_TYPE_CHECK_INSTANCE_CAST ((o), PK_TYPE_DISTRO_UPGRADE, PkDistroUpgrade))
#define PK_DISTRO_UPGRADE_CLASS(k) \
	(G_TYPE_CHECK_CLASS_CAST((k), PK_TYPE_DISTRO_UPGRADE, PkDistroUpgradeClass))
...
#define PK_DISTRO_UPGRADE_GET_CLASS(o) \
	(G_TYPE_INSTANCE_GET_CLASS ((o), PK_TYPE_DISTRO_UPGRADE, PkDistroUpgradeClass))
