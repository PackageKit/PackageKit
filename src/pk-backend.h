...
gboolean     pk_backend_unload (PkBackend *backend) G_GNUC_WARN_UNUSED_RESULT;
...
const gchar *pk_backend_get_name (PkBackend *backend) G_GNUC_WARN_UNUSED_RESULT;
const gchar *pk_backend_get_description (PkBackend *backend) G_GNUC_WARN_UNUSED_RESULT;
const gchar *pk_backend_get_author (PkBackend *backend) G_GNUC_WARN_UNUSED_RESULT;
